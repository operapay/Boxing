...
class MyAppWindow(arcade.Window):
    ...
    def __init__(self, screen_width, screen_height):
        ...
        self.instructions = []
        texture = arcade.load_texture("images/girl.png")
        self.instructions.append(texture)

        texture = arcade.load_texture("images/coin.png")
        self.instructions.append(texture)
    ...
    def setup(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("images/boy.png",
                                           SPRITE_SCALING)
        ...
        for i in range(50):
            ...
            coin = arcade.Sprite("images/score.png", SPRITE_SCALING / 3)
